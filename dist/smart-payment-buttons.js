window.spb = function(modules) {
    ...
    "./src/button/index.js": function(module, __webpack_exports__, __webpack_require__) {
        ...
        var payment_fields_slideDownButtons = function() {
            var buttonsContainer = document.querySelector("#buttons-container");
            querySelectorAll("[data-funding-source]").forEach((function(el) {
                el.style.opacity = "1";
        ...
        var paymentFields = {
            ...
            init: function(_ref3) {
                ...
                var createOrder = props.createOrder, _onApprove = props.onApprove, _onCancel = props.onCancel, locale = props.locale, commit = props.commit, onError = props.onError, sessionID = props.sessionID, fieldsSessionID = props.fieldsSessionID, partnerAttributionID = props.partnerAttributionID, buttonSessionID = props.buttonSessionID, _onAuth = props.onAuth;
                ...
                var _PaymentFields = PaymentFields({
                    fundingSource: fundingSource,
                    fieldsSessionID: fieldsSessionID,
                    onContinue: (_onContinue = (fn = function*(data) {
                        return getConfirmOrder({
                            orderID: yield createOrder(),
                            payload: data,
                            partnerAttributionID: partnerAttributionID
                        }, {
                            facilitatorAccessToken: serviceData.facilitatorAccessToken
                        }).then((function() {
                            (instance = Checkout(_extends({}, props, {
                                onClose: function() {
                                ...
                                onAuth: function(_ref5) {
                                    return _onAuth({
                                        accessToken: _ref5.accessToken || buyerAccessToken
                                    }).then((function(token) {
                                        buyerAccessToken = token;
                                    }));
                                },
                                ...
                                getTop(window);
                                return utils_getParent() ? utils_getParent() : window;
                            }(), "body", "popup");
                        }));
                    }, function() {
                    ...
                    onFieldsClose: function() {
                        return closeCardForm().then((function() {
                            paymentFieldsOpen = !1;
                            payment_fields_slideDownButtons();
                        }));
                    },
                    onError: onError,
                    onClose: function() {
                    ...
                    commit: commit,
                    cspNonce: cspNonce
                }), render = _PaymentFields.render, closeCardForm = _PaymentFields.close;
                var _onContinue, fn;
                var close = function() {
                    return closeCardForm().then((function() {
                        forceClosed = !0;
                        paymentFieldsOpen = !1;
                        instance.close();
                        return payment_fields_slideDownButtons();
                    }));
                };
                return {
                    start: function() {
                        ...
                        !function(fundingSource) {
                            var _getElements = function(fundingSource) {
                                var buttonsContainer = document.querySelector("#buttons-container");
                                var epsButtonsContainer = document.querySelector('[data-funding-source="' + fundingSource + '"]');
                                var paymentFieldsContainer = document.querySelector("#payment-fields-container");
                                if (!buttonsContainer || !epsButtonsContainer || !paymentFieldsContainer) throw new Error("Did not find payment fields elements");
                                return {
                                    buttonsContainer: buttonsContainer,
                                    epsButtonsContainer: epsButtonsContainer,
                                    paymentFieldsContainer: paymentFieldsContainer
                                };
                            }(fundingSource), buttonsContainer = _getElements.buttonsContainer, epsButtonsContainer = _getElements.epsButtonsContainer, paymentFieldsContainer = _getElements.paymentFieldsContainer;
                            if (!buttonsContainer || !epsButtonsContainer || !paymentFieldsContainer) throw new Error("Required elements not found");
                            ...
                            payment_fields_resizeListener = debounce((function() {
                                buttonsContainer.style.transitionDuration = "0s";
                                recalculateMargin();
                            }));
                        ...
                        !function(fundingSource) {
                            fundingSource && querySelectorAll("[data-funding-source]").forEach((function(el) {
                                if (el.getAttribute("data-funding-source") === fundingSource.toLowerCase()) el.style.opacity = "1"; else {
        ...
        var PAYMENT_FLOWS = [ vaultCapture, walletCapture, cardField, cardForm, paymentFields, {
            name: "popup_bridge",
            setup: function(_ref) {
                var props = _ref.props;
                return promise_ZalgoPromise.try((function() {
        ...
        function getPaymentFlow(_ref2) {
            var props = _ref2.props, payment = _ref2.payment, config = _ref2.config, serviceData = _ref2.serviceData, event = _ref2.event;
        ...
        function initiatePaymentFlow(_ref3) {
            var _props$style;
            var payment = _ref3.payment, serviceData = _ref3.serviceData, config = _ref3.config, components = _ref3.components, props = _ref3.props, event = _ref3.event;
                    ...
                    if (!1 !== valid) {
                        ...
                        var confirmOrderPromise = createOrder().then((function(orderID) {
                            return window.xprops.sessionState.get("__confirm_" + fundingSource + "_payload__").then((function(confirmOrderPayload) {
                                if (confirmOrderPayload) return getConfirmOrder({
                                    orderID: orderID,
        ...
        function setupButton(opts) {
            ...
            function initiatePayment(_ref) {
                var payment = _ref.payment, paymentProps = _ref.props, event = _ref.event;
                return promise_ZalgoPromise.try((function() {
